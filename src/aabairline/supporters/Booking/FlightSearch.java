...
public class FlightSearch{
    ...
    public static FlightInfo selectedFlight;
    ...
    public FlightSearch(Button btnOWay, Button btnRTrip, GridPane returnDateTxtField
            ...
            , TableView scheduleTab, Label lbPrice, Label lbTicket)
            throws IOException{
        ...
        FlightSearch.lbTicket = lbTicket;
        //Excute
        FlightSearch.init();
...
//        FlightSearch.loadDestinationCBox();
    ...
    public static void searchBtnHandler() throws URISyntaxException{
        if(isAllEmpty()){
            ModifiedNode.myAlert(Alert.AlertType.WARNING, "Warning"
    ...
    public static void setupTicketTable() throws URISyntaxException{  
        scheduleTa.getColumns().get(0).setCellValueFactory(
    ...
    public static void getSelectedTicket(){
        scheduleTa.setRowFactory(value -> {
            ...
            row.setOnMouseClicked(e ->{
                ...
                if(!row.isEmpty()){ 
                   //set ticket label
                   lbTicket.setText("You chose " + row.getItem().toString());
                   //set price
